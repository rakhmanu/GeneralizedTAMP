...
(:domain GridYx)
(:objects pos-0-0 pos-0-1 pos-0-2 pos-0-3 pos-1-0 pos-1-1 pos-1-2)
(:init (at pos-0-0)
       (visited pos-0-0)
       ...
       (canmoveright pos-0-0 pos-0-1) 
       (canmoveright pos-0-1 pos-0-2) 
       (canmoveright pos-1-0 pos-1-1) 
       (canmoveright pos-1-1 pos-1-2)
)
(:goal (and (visited pos-0-0) (visited pos-0-1) (visited pos-0-2) (visited pos-1-0) (visited pos-1-1) (visited pos-1-2)))
)